...
class RegistryRetrieverTests(unittest.TestCase):
    ...
    def test_registry_cache_management(self):
        ...
        retriever = RegistryRetriever(
            cache_ttl=5, local_cache_dir=self.cache_dir  # 5 seconds TTL
        )
        ...
        self.assertTrue(
            retriever.registry_cache_path.exists(), "Cache file was not created"
        )
    ...
    def test_online_mode(self):
        ...
        self.assertGreater(
            len(registry.get("repositories", [])),
            0,
            "Registry should contain repositories",
        )
        ...
        self.assertTrue(
            ...
            "Cache file should exist after previous calls",
        )
    ...
    def test_persistent_timestamp_across_cli_invocations(self):
        ...
        self.assertTrue(
            retriever1._last_fetch_time_path.exists(),
        ...
        self.assertGreater(
            retriever2._last_fetch_time, 0, "Timestamp should be loaded from disk"
        )
    ...
    def test_persistent_timestamp_edge_cases(self):
        ...
        retriever._load_last_fetch_time()
        self.assertEqual(
            retriever._last_fetch_time,
            0,
            "Corrupt timestamp should be treated as no timestamp",
        )
        ...
        self.assertGreater(
            retriever._last_fetch_time, 0, "Future timestamp should be loaded"
        )
        ...
        self.assertEqual(
            retriever._last_fetch_time,
            0,
            "Empty timestamp file should be treated as no timestamp",
        )
