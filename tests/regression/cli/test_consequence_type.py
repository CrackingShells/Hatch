...
class TestConsequenceTypeProperties(unittest.TestCase):
    ...
    def test_all_types_have_prompt_label(self):
        ...
        for ct in ConsequenceType:
            ...
            self.assertTrue(
                len(ct.prompt_label) > 0, f"{ct.name}.prompt_label should not be empty"
            )
    ...
    def test_all_types_have_result_label(self):
        ...
        for ct in ConsequenceType:
            self.assertTrue(
                hasattr(ct, "result_label"), f"{ct.name} missing result_label property"
            )
            self.assertIsInstance(ct.result_label, str)
            self.assertTrue(
                len(ct.result_label) > 0, f"{ct.name}.result_label should not be empty"
            )
    ...
    def test_all_types_have_prompt_color(self):
        ...
        for ct in ConsequenceType:
            self.assertTrue(
                hasattr(ct, "prompt_color"), f"{ct.name} missing prompt_color property"
            )
    ...
    def test_all_types_have_result_color(self):
        ...
        for ct in ConsequenceType:
            self.assertTrue(
                hasattr(ct, "result_color"), f"{ct.name} missing result_color property"
            )
...
class TestConsequenceTypeColorSemantics(unittest.TestCase):
    ...
    def test_constructive_types_use_green(self):
        ...
        for ct in constructive:
            ...
            self.assertEqual(
                ct.result_color, Color.GREEN, f"{ct.name} result_color should be GREEN"
            )
    ...
    def test_destructive_types_use_red(self):
        ...
        for ct in destructive:
            ...
            self.assertEqual(
                ct.result_color, Color.RED, f"{ct.name} result_color should be RED"
            )
    ...
    def test_noop_types_use_gray(self):
        ...
        for ct in noop:
            self.assertEqual(
                ct.prompt_color, Color.GRAY, f"{ct.name} prompt_color should be GRAY"
            )
            self.assertEqual(
                ct.result_color, Color.GRAY, f"{ct.name} result_color should be GRAY"
            )
