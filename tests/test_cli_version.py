...
class TestVersionCommand(unittest.TestCase):
    ...
    def test_get_hatch_version_retrieves_from_metadata(self):
        ...
        with patch(
            "hatch.cli.cli_utils.version", return_value="0.7.0-dev.3"
        ) as mock_version:
    ...
    def test_version_command_displays_correct_format(self):
        ...
        with patch("sys.argv", test_args):
            ...
            with patch(
                "hatch.cli.__main__.get_hatch_version", return_value="0.7.0-dev.3"
            ):
    ...
    def test_no_conflict_with_package_version_flag(self):
        ...
        with patch("sys.argv", test_args):
            with patch("hatch.environment_manager.HatchEnvironmentManager") as mock_env:
                ...
                self.assertEqual(
                    call_args[0][2], "1.0.0"
                )  # Third positional arg is version
