...
class TestDataLoader:
    ...
    def _create_default_config(self, config_name: str):
        ...
        default_configs = {
            ...
            "installer_configs": {
                "python_installer": {"pip_timeout": 60, "use_cache": False},
                "docker_installer": {"timeout": 120, "cleanup_containers": True},
            },
        }
    ...
    def _create_default_response(self, response_name: str):
        ...
        default_responses = {
            "registry_responses": {
                "success": {"status": "success", "data": {"packages": []}},
                "error": {"status": "error", "message": "Registry not available"},
            }
        }
...
class MCPBackupTestDataLoader(TestDataLoader):
    ...
    def _create_default_mcp_config(self, config_type: str):
        ...
        default_configs = {
            "simple_server": {
                "servers": {"test_server": {"command": "python", "args": ["server.py"]}}
            },
            "complex_server": {
                "servers": {
...
class MCPHostConfigTestDataLoader(TestDataLoader):
    ...
    def load_host_config_template(
        self, host_type: str, config_type: str = "simple"
    ) -> Dict[str, Any]:
    ...
    def load_corrected_environment_data(
        self, data_type: str = "simple"
    ) -> Dict[str, Any]:
    ...
    def _create_host_config_template(self, host_type: str, config_type: str):
        ...
        templates = {
            ...
            "kiro_complex": {
                ...
                "otherSettings": {"theme": "dark", "fontSize": 14},
            },
        }
    ...
    def _create_mcp_server_config(self, server_type: str):
        ...
        templates = {
            ...
            "local_minimal": {"command": "python", "args": ["minimal_server.py"]},
            "remote_minimal": {"url": "https://minimal.example.com/mcp"},
        }
